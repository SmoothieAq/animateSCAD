...
module myModel() {
	...
	move("part2",[
		mpoint(pos=[-840,-190,90],color=[128/255,128/255,0,0],rotate=[0,0,0]),
		mpoint(cRel=["p20",-0.6],pos=[-110,-190,90],color=[128/255,128/255,0,1],rotate=[0,0,360]),
...
$camera = camera(cpoints=[
		...
		cpoint("p15",pos=[350, 120, 40]),
		cpoint("p20",pos=[350, 120, 40],time=0.2),
